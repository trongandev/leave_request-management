...
import { Loader2, SendHorizonal, Sparkles, Trash2, X } from "lucide-react"
...
export default function ChatAI() {
    ...
    const defaultSuggestionChat = [
        "Các đơn đang chờ duyệt của tôi là gì?",
    ...
    return (
        <>
            <div
                className={`fixed ${isOpen ? "bottom-5 right-5 z-50" : "bottom-5 -right-full"} transition-all duration-300 ease-in-out  w-full md:max-w-sm p-5 rounded-xl shadow-lg border bg-card flex flex-col z-50`}
            >
                ...
                <div className="flex-1 py-4 max-h-[58vh] overflow-y-auto space-y-3">
